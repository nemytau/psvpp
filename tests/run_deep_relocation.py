#!/usr/bin/env python3
"""Execute destroy+repair followed by deep relocation across multiple datasets."""
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        help="Destroy operator name applied before deep relocation (default: random_visit_removal).",
    )
    parser.add_argument(
        "--repair",
        default="deep_greedy_insertion",
        help="Repair operator name applied before deep relocation (default: deep_greedy_insertion).",
    )
    parser.add_argument(
        "--improvement",
        default="deep_relocation",
        help="Improvement operator name invoked for snapshots (default: deep_relocation).",
    )
    parser.add_argument(
        "--output-dir",
        type=Path,
        default=Path("rust_alns/output/python/deep_relocation"),
    ...
    parser.add_argument(
        ...
        help=(
            ...
            "before applying the deep relocation operator."
        ),
    )
    parser.add_argument(
        "--export-summary",
